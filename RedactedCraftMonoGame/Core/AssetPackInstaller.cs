...
public sealed class AssetPackInstaller
{
    ...
    {
        EnsureWritableDirectory(Paths.RootDir, "Documents\\RedactedCraft");
        EnsureWritableDirectory(assetsDir, "Documents\\RedactedCraft\\Assets");
    }
    ...
    {
        EnsureWritableDirectory(DownloadsDir, "Documents\\RedactedCraft\\_downloads");
    ...
    private void FindAndPrepareAssets(string stagingDir)
    {
        ...
        // - staging/Redactedcraft-Assets-main/textures
        // - staging/Redactedcraft-Assets-main/Assets/textures
    ...
    public void WriteInstalledMarker(AssetReleaseInfo release)
    {
        try
        {
            EnsureWritableDirectory(Paths.AssetsDir, "Documents\\RedactedCraft\\Assets");
            Paths.EnsureAssetDirectoriesExist(_log);
    ...
    private static HttpClient CreateHttpClient()
    {
        ...
        client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("RedactedCraftMonoGame", "1.0"));
