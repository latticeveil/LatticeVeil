...
public static class BlockRegistry
{
    ...
    static BlockRegistry()
    {
        ...
        Register(new BlockDef(BlockId.Door, "Door", solid: true, transparent: true, hardness: 1.0f, atlasIndex: 8, customModel: true));
        Register(new BlockDef(BlockId.DoorOpen, "Door Open", solid: false, transparent: true, hardness: 1.0f, atlasIndex: 9, visible: false, customModel: true));
