    ...
    public static DifficultyTuning GetTuning(int difficulty)
    {
        return Clamp(difficulty) switch
        {
            ...
            1 => new DifficultyTuning(
                IdleHungerIntervalSeconds: 50f,
                WalkHungerIntervalSeconds: 25f,
                SprintHungerIntervalSeconds: 12f,
            ...
            2 => new DifficultyTuning(
                IdleHungerIntervalSeconds: 36f,
                WalkHungerIntervalSeconds: 18f,
                SprintHungerIntervalSeconds: 9f,
            ...
            3 => new DifficultyTuning(
                IdleHungerIntervalSeconds: 26f,
                WalkHungerIntervalSeconds: 13f,
                SprintHungerIntervalSeconds: 6f,
