...
{
    public const string DefaultDeathType = "soul";
    ...
    public bool SaveInventory { get; set; } = false;
    public bool SharedSoulAccess { get; set; } = false;
    public bool EnablePvp { get; set; } = false;
    public string DeathType { get; set; } = DefaultDeathType;
