...
public sealed class CreateWorldScreen : IScreen
{
    ...
    private bool _worldNameSelectAll;
    ...
    private void OpenMoreWorldOptions()
    {
        var moreOptionsScreen = new MoreWorldOptionsScreen(
            ...
            _multipleHomesEnabled, _maxHomesPerPlayer, _playerCollisionEnabled, _pvpEnabled, _maxHomesCap,
    ...
    public void Update(GameTime gameTime, InputState input)
    {
        ...
        if (input.IsNewLeftClick())
            TextFieldVisuals.HandleWholeFieldPointerSelection(input, _worldNameRect, ref _worldNameActive, ref _worldNameSelectAll, _worldName);
    ...
    public void Draw(SpriteBatch sb, Rectangle viewport)
    {
        ...
        TextFieldVisuals.DrawWholeFieldSelection(sb, _pixel, _font, _worldName, worldNamePos, _worldNameRect, _worldNameSelectAll, new Color(88, 148, 218, 170));
        _font.DrawString(sb, worldNameText, worldNamePos, worldNameColor);
        TextFieldVisuals.DrawCaret(sb, _pixel, _font, _worldName, worldNamePos, _worldNameRect, _worldNameActive, _worldNameSelectAll, _now, Color.White);
    ...
    private void CreateWorld()
    {
        ...
        meta.Gameplay.EnablePvp = _pvpEnabled;
    ...
    private void BeginResumeGeneration()
    {
        ...
        _pvpEnabled = meta.Gameplay?.EnablePvp ?? false;
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            worldConfig.Gameplay.EnablePvp = _pvpEnabled;
    ...
    private void HandleTextInput(InputState input, ref string value, int maxLen)
    {
        ...
        foreach (var key in input.GetTextInputKeys())
        {
            ...
            if (key == Keys.Space)
            {
                if (_worldNameSelectAll) value = string.Empty;
